...
export const GetTimeWizard = new WizardScene(
    ...
    ctx => {    
        ...
        const timezones = time.getTimezonesForCountry(id);
        let buttons: Array<Array<CallbackButton>> = new Array();
        let timezoneNames = Array<string>();
        ...
        for(let i = 0; i < timezoneNames.length; i++){
            let row = new Array<CallbackButton>();
